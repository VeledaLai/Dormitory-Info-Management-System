  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-30% w3-container">
     <form action="/admin/checkin" method="post">
      @csrf
      <h1 class="w3-text-teal">入住申请管理</h1>
      <div style="background-color:AliceBlue;">
       <br>@php
            if($apply == []){
                echo "<br><br><center><h4 style='color:#455A64'>暂无待审批的入住申请名单</h4></center><br>";
            }
            else{
                echo "<h3 style='color:#455A64;margin-left:50px;'>个人申请名单：</h3>
                    <br>
                ...
                foreach($apply as $a){
                    $num++;
                    echo "<tr><td><input type='checkbox' name='select[]' value='$a->studentid' oninput='clickCheckbox()'></td>
                        <td>$num</td>
                        <td>$a->name</td>
                        <td>$a->studentid</td>
                        <td>$a->classes</td>
...
<script>
  ...
  <footer id="myFooter" style="margin-left">
   ...
   <a href="/admin" target="_blank"><h4>返回主页</h4></a>
    </div>
